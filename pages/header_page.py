...
class HeaderPage(BasePage):
    """
    Třída reprezentující hlavičku stránky (Header), která je společná pro více stránek.
    """

    def load(self) -> None:
        """
        Načte domovskou stránku (pro testování hlavičky) a potvrdí cookies.
        """
        self.navigate(config.BASE_URL)
        self.accept_cookies()

    def informace_menu_is_visible_when_hover_over(self) -> None:
        """
        Ověří, že menu "Informace" se zobrazí po najetí myší.
        """
        ...
        self.hover(informace_button, name="Tlačítko Informace")
        self.expect_visible(informace_menu, name="Menu Informace")

    def informace_menu_content(self) -> None:
        """
        Ověří obsah menu "Informace" (jednotlivé položky).
        """
        informace_button = self.page.get_by_role("link", name="Informace")
        self.hover(informace_button, name="Tlačítko Informace")
    ...
    def prodejny_menu_is_visible_when_hover_over(self) -> None:
        """
        Ověří, že menu "Prodejny" se zobrazí po najetí myší.
        """
        ...
        self.hover(prodejny_button, name="Tlačítko Prodejny")
        self.expect_visible(prodejny_menu, name="Menu Prodejny")

    def prodejny_menu_content(self) -> None:
        """
        Ověří obsah menu "Prodejny" (seznam poboček).
        """
        prodejny_button = self.page.get_by_role("banner").get_by_role("link", name="Prodejny")
        self.hover(prodejny_button, name="Tlačítko Prodejny")
